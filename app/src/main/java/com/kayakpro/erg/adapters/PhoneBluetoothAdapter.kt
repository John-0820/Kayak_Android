...
/**
 * Adapter for showing nearby Android phones for Player1 & Player2 training mode
 */
class PhoneBluetoothAdapter(
    private val items: MutableList<BtRow>,
    private val onClickBluetooth: OnClickBluetooth
) : RecyclerView.Adapter<PhoneBluetoothAdapter.ItemView>() {
    ...
    override fun onBindViewHolder(holder: ItemView, position: Int) {
        ...
        holder.binding.tvBluetoothName.text = row.device.name ?: "Unknown Phone"
