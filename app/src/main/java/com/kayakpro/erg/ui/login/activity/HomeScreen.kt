...
class HomeScreen : AppCompatActivity(), AppBarCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val deactivateItem = binding.navView.menu.findItem(R.id.nav_ddeactivate)
        val spanTitle = SpannableString(deactivateItem.title)
        spanTitle.setSpan(ForegroundColorSpan(0xFFFF0000.toInt()), 0, spanTitle.length, 0)
        deactivateItem.title = spanTitle
    ...
    private fun deleteAccount() {
        ...
        deleteViewModel.error.observe(this) { _ ->
    ...
    private fun visibleBottomNavigation(id: Int) {
        if (id == R.id.nav_home) {
            binding.appBarMain.appbarmain.elevation = 0f
